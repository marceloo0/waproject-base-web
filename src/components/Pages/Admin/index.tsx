...
import ShoppingCartAddIcon from 'mdi-react/ShoppingCartAddIcon';
...
import OrdersIndexPage from './OrderProducts';
...
const AdminPage = memo((props: {}) => {
  ...
  const [menu] = useState([
    ...
    { path: '/pedidos', display: 'Pedidos', icon: ShoppingCartAddIcon }
  ]);
